...
class PartikelClass {
  ...
  public:
    ...
    void SetRed(int value) { red = static_cast<uint8_t>(std::clamp(value, 0, 255)); }

    void SetGreen(int value) { green = static_cast<uint8_t>(std::clamp(value, 0, 255)); }

    void SetBlue(int value) { blue = static_cast<uint8_t>(std::clamp(value, 0, 255)); }

    void SetAlpha(int value) { alpha = static_cast<uint8_t>(std::clamp(value, 0, 255)); }
